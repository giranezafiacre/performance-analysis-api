...
class File(models.Model):
    File_name = models.CharField(max_length=100,help_text='enter file name', unique=True)
    Actual_file=models.FileField(upload_to='app/uploads/',help_text='upload file in csv format')
